      ...
      <TicketGridStyled>
        ...
        <TicketInfoStyled>
          <TicketInfoWrapperStyled>
            <TicketDateStyled>{data?.departure_time}</TicketDateStyled>
            <TicketPlaceStyled>
              {data?.destination}, {data?.origin_name}
              <TicketFullDateStyled>{data?.departure_date}</TicketFullDateStyled>
            </TicketPlaceStyled>
          </TicketInfoWrapperStyled>
          <TicketLineStyled>{data?.stops} пересадка</TicketLineStyled>
          <TicketInfoWrapperStyled>
            <TicketDateStyled>{data?.arrival_time}</TicketDateStyled>
            <TicketPlaceStyled>
              {data?.destination_name}, {data?.carrier}
              <TicketFullDateStyled>{data?.arrival_date}</TicketFullDateStyled>
            </TicketPlaceStyled>
          </TicketInfoWrapperStyled>
        </TicketInfoStyled>
      </TicketGridStyled>
